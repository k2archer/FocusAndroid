package com.k2archer.demo.lib_base.utils;
...
public class LocalStorageKVUtils {
    ...
    public int decodeInt(String key, int defValue) {
        return getSharedPreferences().getInt(key, defValue);
    }

    public long decodeLong(String key, long defValue) {
        return getSharedPreferences().getLong(key, defValue);
    }

    public float decodeFloat(String key, float defValue) {
        return getSharedPreferences().getFloat(key, defValue);
    }

    public boolean decodeBoolean(String key, boolean defValue) {
    ...
    public boolean encodeStringSet(String key, Set<String> values) {
        SharedPreferences.Editor e = getSharedPreferences().edit();
    ...
    public boolean encodeInt(String key, int value) {
        SharedPreferences.Editor e = getSharedPreferences().edit();
        e.putInt(key, value);
        e.apply();
        return true;
    ...
    public boolean encodeFloat(String key, float value) {
        SharedPreferences.Editor e = getSharedPreferences().edit();
