package cn.openwatch.demo.view;
...
import cn.openwatch.demo.common.Feature;
...
//        getNotificationManager().notify(1, NotificationUtils.getNotificationBuilder(context).packing());
        Notification b = NotificationUtils.getNotificationBuilder(context).build();
